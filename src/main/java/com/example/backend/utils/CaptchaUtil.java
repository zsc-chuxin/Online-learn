...
public class CaptchaUtil {
    ...
    private final static String IMG_URL = "https://picsum.photos/320/155";

    private final static String IMG_PATH = "D:/Online-learn/backend/src/main/resources/static/1.jpg";
    ...
    public static void checkCaptcha(Captcha captcha){
        ...
        if (captcha.getBlockWidth() == null){
            captcha.setBlockWidth(60);
        }
        if (captcha.getBlockHeight() == null){
            captcha.setBlockHeight(60);
        }
